...
import { ArrowLeft, MapPin, Award, ChefHat } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {restaurantBounties.length === 0 ? (
              ...
              restaurantBounties.map((bounty: any) => (
                <Card key={bounty._id ?? bounty.id ?? bounty.dishName ?? bounty.recipeName}>
                  <CardHeader>
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex items-center gap-1 text-primary">
                        ...
                        <span className="font-semibold">{bounty.pointReward ?? bounty.points ?? 0}</span>
                      </div>
                    </div>
                    <CardTitle className="lowercase">{bounty.dishName ?? bounty.recipeName ?? 'bounty'}</CardTitle>
